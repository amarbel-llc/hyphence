...
- [linenisgreat/hyphence#5](https://code.linenisgreat.com/linenisgreat/hyphence/issues/5) — the `Document.TrailingComments` naming collision between document-tail comments and this RFC's inline trailing comments, for future implementation work.
